          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {produs.tags?.includes("produse-noi") && (
                <span style={{ background: "#111", color: "#fff", fontSize: 11, fontWeight: 700, padding: "4px 12px", borderRadius: 4, textTransform: "uppercase", letterSpacing: "0.1em" }}>NOU</span>
              )}
              {hasDiscount && (
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 32, fontWeight: 800, color: hasDiscount ? "#dc2626" : "#111" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {(produs.culori || []).map(c => (
                  <button key={c} onClick={() => setSelectedCuloare(c)} style={{
                    padding: "8px 18px", border: selectedCuloare === c ? "2px solid #111" : "1px solid #ddd",
                    background: selectedCuloare === c ? "#111" : "#fff", color: selectedCuloare === c ? "#fff" : "#333",
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                {(produs.marimi || []).map(m => (
                  <button key={m} onClick={() => setSelectedMarime(m)} style={{
                    width: 52, height: 52, border: selectedMarime === m ? "2px solid #111" : "1px solid #ddd",
                    background: selectedMarime === m ? "#111" : "#fff", color: selectedMarime === m ? "#fff" : "#333",
            ...
            <button
              ...
              style={{
                width: "100%", padding: "18px 0", background: addedToCart ? "#16a34a" : "#111",
