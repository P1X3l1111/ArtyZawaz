    ...
    return (
      <>
        ...
        <main style={{ paddingTop: 120, minHeight: "70vh", maxWidth: 560, margin: "0 auto", padding: "120px 24px 80px", textAlign: "center" }}>
          ...
          <Link href="/" style={{ display: "inline-block", background: "#111", color: "#fff", padding: "14px 36px", borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: "none", letterSpacing: "0.08em", textTransform: "uppercase" }}>
            Înapoi acasă
          </Link>
        </main>
        <Footer />
        ...
        <main style={{ paddingTop: 120, minHeight: "70vh", maxWidth: 600, margin: "0 auto", padding: "120px 24px 80px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <button
              ...
              disabled={trimis}
              style={{ background: trimis ? "#888" : "#111", color: "#fff", padding: "16px", borderRadius: 10, fontWeight: 800, fontSize: 15, border: "none", cursor: trimis ? "not-allowed" : "pointer", letterSpacing: "0.1em", textTransform: "uppercase" }}
            >
      ...
      <main style={{ paddingTop: 120, minHeight: "70vh", maxWidth: "var(--container)", margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        {cos.length === 0 ? (
          <div style={{ textAlign: "center", paddingTop: 60, display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
            ...
            <Link href="/" style={{ display: "inline-block", background: "#111", color: "#fff", padding: "12px 32px", borderRadius: 8, fontWeight: 700, fontSize: 13, textDecoration: "none", letterSpacing: "0.08em", textTransform: "uppercase" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: 48, alignItems: "start" }}>
            ...
            <div style={{ background: "#faf9f7", borderRadius: 16, padding: 28, position: "sticky", top: 120 }}>
              ...
              <button
                ...
                style={{ width: "100%", background: "#111", color: "#fff", padding: "15px", borderRadius: 10, fontWeight: 800, fontSize: 14, border: "none", cursor: "pointer", letterSpacing: "0.08em", textTransform: "uppercase" }}
              >
                Finalizează comanda
              </button>
            </div>
