      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(40px, 6vw, 64px) clamp(20px, 4vw, 64px)" }}>
        {produse.length === 0 ? (
          <div style={{ textAlign: "center", padding: "80px 0", color: "#bbb" }}>
            ...
            <Link href="/" style={{ marginTop: 16, display: "inline-block", padding: "12px 24px", background: "#111", color: "#fff", borderRadius: 10, textDecoration: "none", fontWeight: 700 }}>Înapoi acasă</Link>
          </div>
        ) : (
