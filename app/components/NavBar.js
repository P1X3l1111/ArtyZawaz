      ...
      <div style={{
        ...
        {cos.length > 0 && (
          <div style={{ padding: "20px 24px", borderTop: "1px solid #f0f0f0", display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <Link href="/cos" onClick={onClose} style={{ display: "block", background: "#111", color: "#fff", padding: "14px", borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: "none", textAlign: "center", letterSpacing: "0.06em", textTransform: "uppercase" }}>
              Finalizează comanda
            </Link>
          </div>
        )}
        {cos.length === 0 && (
          <div style={{ padding: "20px 24px", borderTop: "1px solid #f0f0f0" }}>
            <Link href="/" onClick={onClose} style={{ display: "block", background: "#111", color: "#fff", padding: "14px", borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: "none", textAlign: "center", letterSpacing: "0.06em", textTransform: "uppercase" }}>
          ...
          <div style={{ maxWidth: "var(--container)", margin: "0 auto", padding: "28px 16px 32px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap", paddingBottom: 20, marginBottom: 24, borderBottom: "1px solid #f0eeeb" }}>
              <Link href={link.href} onClick={() => setActiveDropdown(null)}
                style={{ padding: "6px 16px", borderRadius: 999, fontSize: 12, fontWeight: 700, background: "#111", color: "#fff", textDecoration: "none", whiteSpace: "nowrap" }}
              >Toate</Link>
              {link.subcategorii.map(sub => (
                <Link key={sub.href} href={sub.href} onClick={() => setActiveDropdown(null)}
                  style={{ padding: "6px 16px", borderRadius: 999, fontSize: 12, fontWeight: 700, background: "#f5f3ef", color: "#111", textDecoration: "none", whiteSpace: "nowrap", transition: "background 0.2s, color 0.2s" }}
                  onMouseEnter={e => { e.currentTarget.style.background = "#111"; e.currentTarget.style.color = "#fff"; }}
                  onMouseLeave={e => { e.currentTarget.style.background = "#f5f3ef"; e.currentTarget.style.color = "#111"; }}
                >{sub.label}</Link>
              ))}
            </div>
            {/* Products row */}
